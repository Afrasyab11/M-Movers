                      ...
                      <div className="row">
                        <div className="col-12">
                          <img
                            className="img-fluid rounded"
                            src={halfTruc}
                            alt="Mover three Bedroom with movers"
                          />
                        </div>
                        <div className="col-12 my-2">
                          <a
                      ...
                      <div className="row">
                        <div className="col-12">
                          <img
                            className="img-fluid rounded"
                            src={fourVilla}
                            alt="Move Four Bedroom Villa Apartment"
                          />
                        </div>
                        <div className="col-12 my-2">
                          <a
